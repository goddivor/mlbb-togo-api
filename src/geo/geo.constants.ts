...
export const TOGO_CITIES: TogoCity[] = [
  ...
  { id: 'agou', name: 'Agou', region: 'plateaux', lat: 6.8167, lng: 0.75, aliases: ['agou-gadzepe', 'agou gadzepe'] },
  ...
  { id: 'danyi', name: 'Danyi', region: 'plateaux', lat: 7.15, lng: 0.65, aliases: ['danyi-apeyeme', 'apeyeme'] },
  ...
  { id: 'kande', name: 'Kandé', region: 'kara', lat: 9.9333, lng: 1.0333 },
  ...
  { id: 'mango', name: 'Mango', region: 'savanes', lat: 10.3567, lng: 0.4711, aliases: ['sansanne-mango', 'sansanne mango', 'sansanne'] },
